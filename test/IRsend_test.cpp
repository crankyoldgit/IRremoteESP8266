...
TEST(TestSendManchester, SendZeroBits) {
  ...
  EXPECT_EQ("", irsend.outputStr());
  irsend.sendManchester(1, 2, 700, 3, 4, 0b1, 0);
...
TEST(TestSendManchester, SendSingleBit) {
  ...
  EXPECT_EQ("f38000d50m1000s2000m100s100m3000s4000", irsend.outputStr());
}
...
TEST(TestSendManchester, SendOverLargeData) {
  ...
  EXPECT_EQ(
      "f38000d50"
      "m100s201"
      "m1s1m1s1m1s1m1s1m1s1"
      "m2s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1"
      "m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1"
      "m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1"
      "m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1m1s1"
      "m300",
      irsend.outputStr());
}
