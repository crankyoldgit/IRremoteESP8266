...
uint8_t IRDaikin216::getFan() {
  uint8_t fan = (remote_state[kDaikin216ByteFan] & kDaikin216MaskFan) >> 4;
  if (fan != kDaikinFanQuiet && fan != kDaikinFanAuto) fan -= 2;
  return fan;
}
...
uint8_t IRDaikin160::getSwingVertical() {
...
stdAc::swingv_t IRDaikin160::toCommonSwingV(const uint8_t setting) {
  switch (setting) {
    case kDaikin160SwingVHigh : return stdAc::swingv_t::kHighest;
    case kDaikin160SwingVHigh +1 : return stdAc::swingv_t::kHigh;
    case kDaikin160SwingVHigh +2: return stdAc::swingv_t::kMiddle;
    case kDaikin160SwingVLow -1 : return stdAc::swingv_t::kLow;
    case kDaikin160SwingVLow : return stdAc::swingv_t::kLowest;
    default: return stdAc::swingv_t::kAuto;
  }
}
