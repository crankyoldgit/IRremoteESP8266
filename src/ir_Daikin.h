...
/*
        Daikin AC map for class IRDaikinESP
        byte 6=
          b4:Comfort
...
// Daikin 160 bit protocol for ARC423A5 models
/*
...
Vertical function byte 13
Daikin AC has Vertical position stop total 5 positions. Need fine tuning, currently only works with fixed position
    POS 1 (lowest)  = 0b00010001 = 0x11
    POS 2           = 0b00100001 = 0x21
    POS 3           = 0b00110001 = 0x31
    POS 4           = 0b01000001 = 0x41
    POS 5 (highest) = 0b01010001 = 0x51
    SWING ON        = 0B11110001 = 0xF1

Temperature function byte 16

Fan speed function byte 17
 * 
 */

const uint16_t kDaikin160Freq = 38000;  // Modulation Frequency in Hz.
const uint16_t kDaikin160HdrMark = 5010;
const uint16_t kDaikin160HdrSpace = 2160;
const uint16_t kDaikin160BitMark = 330;
const uint16_t kDaikin160OneSpace = 1800;
const uint16_t kDaikin160ZeroSpace = 720;
const uint16_t kDaikin160Gap = 29480;
...
//const uint8_t kDaikin160ByteSwingH = 13;
//const uint8_t kDaikin160MaskSwingH = kDaikin160MaskSwingV;
// Legacy defines.
...
// Class emulate Daikin 160bits ARC423A5
class IRDaikin160 {
 public:
