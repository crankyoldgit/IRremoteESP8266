...
{
  _.TempS1 = code >> 1;     // save 4 bits in Section1
  _.TempS2 = code >> 1;     // Section2 = Section1
...
{
  _.FanS1 = speed >> 6;         // save 3 bits in Section1
  _.FanS2 = speed >> 6;         // Section2 = Section1
...
{
  _.ModeS1 = mode >> 1;         // save 2 bits in Section1
  _.ModeS2 = mode >> 1;         // Section2 = Section1
  _.ModeS3 = mode & 0b1;        // save 1 bit in Section3
  if( mode == kBosch144Auto || mode == kBosch144Dry )
  {
    _.FanS1 = 0b000;            // save 3 bits in Section1
    _.FanS2 = _.FanS1;          // Section2 = Section1
...
{
  _.ChecksumS3 =  _.raw[ 12 ];
  _.ChecksumS3 += _.raw[ 13 ];
  _.ChecksumS3 += _.raw[ 14 ];
  _.ChecksumS3 += _.raw[ 15 ];
  _.ChecksumS3 += _.raw[ 16 ];
}
