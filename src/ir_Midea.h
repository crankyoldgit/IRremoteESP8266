...
const uint64_t kMideaACSleep = 1ULL << kMideaACSleepOffset;
const uint8_t kMideaACPowerOffset = 39;
const uint64_t kMideaACPower = 1ULL << kMideaACPowerOffset;
...
const uint64_t kMideaACCelsiusBit = 1 << kMideaACCelsiusOffset;
