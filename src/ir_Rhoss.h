...
union RhossProtocol{
  ...
  struct {
    // Byte 0
    uint8_t       :8; // Typically 0x55
    // Byte 1
    uint8_t Temp  :4;
    uint8_t       :4; // Typically 0x0
    // Byte 2
    uint8_t       :8; // Typically 0x6
    // Byte 3
...
// Modes
const uint8_t kRhossHeat =     0b0001;
const uint8_t kRhossCool =     0b0010;
const uint8_t kRhossDry =      0b0011;
const uint8_t kRhossFan =      0b0100;
const uint8_t kRhossAuto =     0b0101;

// Temperature
const uint8_t kRhossMinTemp = 16;  // Celsius
const uint8_t kRhossMaxTemp = 30;  // Celsius
