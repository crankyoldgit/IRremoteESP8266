...
class IRCoolixAC {
 public:
  ...
  uint8_t getMode();
  void setSwing(const bool send = true);
  bool getSwing();
  void setSwingH(const bool send = true);
  bool getSwingH();
  void setSwingV(const bool send = true);
  bool getSwingV();
  void setSleep(const bool send = true);
  bool getSleep();
  void setTurbo(const bool send = true);
  bool getTurbo();
  void setLed(const bool send = true);
  bool getLed();
  void setClean(const bool send = true);
  bool getClean();
  bool getZoneFollow();
  uint32_t getRaw();
