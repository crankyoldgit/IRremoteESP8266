...
class IRCoolixAC {
 public:
  ...
  uint8_t getMode();
  void setSwing(const bool sendflag = true);
  bool getSwing();
  void setSwingH(const bool sendflag = true);
  bool getSwingH();
  void setSwingV(const bool sendflag = true);
  bool getSwingV();
  void setSleep(const bool sendflag = true);
  bool getSleep();
  void setTurbo(const bool sendflag = true);
  bool getTurbo();
  void setLed(const bool sendflag = true);
  bool getLed();
  void setClean(const bool sendflag = true);
  bool getClean();
  bool getZoneFollow();
  uint32_t getRaw();
