...
const uint8_t kWhirlpoolAcSwing1Mask = 1 << kWhirlpoolAcSwing1Offset;  // 0x80
const uint8_t kWhirlpoolAcSwing2Offset = 6;
const uint8_t kWhirlpoolAcSwing2Mask = 1 << kWhirlpoolAcSwing2Offset;  // 0x40
const uint8_t kWhirlpoolAcLightOffset = 5;
const uint8_t kWhirlpoolAcLightMask = 1 << kWhirlpoolAcLightOffset;  // 0x20
const uint8_t kWhirlpoolAcPowerToggleOffset = 2;  // 0b00000100
const uint8_t kWhirlpoolAcPowerToggleMask = 1 << kWhirlpoolAcPowerToggleOffset;
const uint8_t kWhirlpoolAcPowerTogglePos = 2;
const uint8_t kWhirlpoolAcSleepOffset = 3;
const uint8_t kWhirlpoolAcSleepMask = 1 << kWhirlpoolAcSleepOffset;  // 0x08;
...
const uint8_t kWhirlpoolAcTimerEnableMask = 1 << kWhirlpoolAcTimerEnableOffset;
