...
const uint8_t kSamsungAcPowerMask1 = 1 << kSamsungAcPower1Offset;  // 0b00100000
...
const uint8_t kSamsungAcBeepMask = 1 << kSamsungAcBeepOffset;  // 0b00000010
const uint8_t kSamsungAcClean10Offset = 7;
const uint8_t kSamsungAcCleanMask10 = 1 << kSamsungAcClean10Offset;  // 0x80
const uint8_t kSamsungAcClean11Offset = 1;     // 0b00000010
const uint8_t kSamsungAcCleanMask11 = 1 << kSamsungAcClean11Offset;  // 0b0010
const uint8_t kSamsungAcQuiet1Offset = 4;
const uint8_t kSamsungAcQuietMask1 = 1 << kSamsungAcQuiet1Offset;  // 0b00010000
const uint8_t kSamsungAcQuiet5Offset = 5;
const uint8_t kSamsungAcQuietMask5 = 1 << kSamsungAcQuiet5Offset;  // 0b00100000
