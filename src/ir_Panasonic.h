...
const uint8_t kPanasonicAcPower = 1 << kPanasonicAcPowerOffset;  // 0b00000001
...
const uint8_t kPanasonicAcQuiet = 1 << kPanasonicAcQuietOffset;  // 0b00000001
const uint8_t kPanasonicAcPowerfulOffset = 5;   // 0b100000
const uint8_t kPanasonicAcPowerful = 1 << kPanasonicAcPowerfulOffset;  // 0x20
// CKP & RKR models have Powerful and Quiet bits swapped.
const uint8_t kPanasonicAcQuietCkpOffset = kPanasonicAcPowerfulOffset;
const uint8_t kPanasonicAcQuietCkp = 1 << kPanasonicAcQuietCkpOffset;  // 0x20
const uint8_t kPanasonicAcPowerfulCkpOffset = kPanasonicAcQuietOffset;
const uint8_t kPanasonicAcPowerfulCkp = 1 << kPanasonicAcPowerfulCkpOffset;
...
const uint8_t kPanasonicAcOnTimer = 1 << kPanasonicAcOnTimerOffset;  // 0b10
const uint8_t kPanasonicAcOffTimerOffset = 2;
const uint8_t kPanasonicAcOffTimer = 1 << kPanasonicAcOffTimerOffset;  // 0b100
