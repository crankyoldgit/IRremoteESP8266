  ...
  String modelToStr(const decode_type_t protocol, const int16_t model) {
    switch (protocol) {
      ...
      case decode_type_t::GREEN:
        switch (model) {
          case green_ac_remote_model_t::YAW1FG: return kYaw1fStr;
          case green_ac_remote_model_t::YBOFBG: return kYbofbStr;
          default:                            return kUnknownStr;
        }
        break;
      case decode_type_t::ELUX:
        switch (model) {
          case elux_ac_remote_model_t::EAW1F: return kEaw1fStr;
          case elux_ac_remote_model_t::EBOFB: return kEbofbStr;
          default:                            return kUnknownStr;
        }
        break; 
