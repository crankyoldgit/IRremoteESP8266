...
void handleRoot() {
  server.send(200, "text/html",
    "<html><head><title>IR Codes server</title></head>"
    "<body>"
    "<h1>ESP8266 IR Server</h1>"
    "<br><hr>"
    ...
    "<form method='POST' action='/ir' enctype='multipart/form-data'>"
      ...
      "</select>"
      "Code: 0x<input type='text' name='code' min='0' value='0'>"
      "Bit size: "
      "<select name='bits'>"
    ...
    "<form method='POST' action='/ir' enctype='multipart/form-data'>"
      ...
      "GlobalCache String: 1:1,1,<input type='text' name='code'"
